package org.coursera.capstone.symptom.auth;
...
public class OAuth2SecurityConfiguration {
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("drJohn", "dr32i", "ADMIN", "USER"),
							User.create("drPeter", "dr54j", "ADMIN","USER"),
							User.create("george", "pt12o", "USER"),
							User.create("hope", "pt66n", "USER"),
							User.create("maria", "pt19j", "USER"),
							User.create("paul", "pt06q", "USER")
							));
    ...
    EmbeddedServletContainerCustomizer containerCustomizer(
            @Value("${keystore.file:src/main/resources/private/keystore2.jks}") String keystoreFile,
            @Value("${keystore.pass:coursera}") final String keystorePass) throws Exception {
		            ...
		            tomcat.addConnectorCustomizers(
		                    new TomcatConnectorCustomizer() {
								...
								public void customize(Connector connector) {
			                        ...
			                        proto.setKeyAlias("server-alias");
								}
		                    });
